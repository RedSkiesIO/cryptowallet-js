        ...
        (function (ERC20) {
            var ERC20SDK = /** @class */ (function () {
                ...
                ERC20SDK.prototype.getTokenData = function (address, network) {
                    var _this = this;
                    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var web3, abiArray, valid, contract, decimals, name_1, symbol, err_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                ...
                ERC20SDK.prototype.getTransactionHistory = function (erc20Wallet, startBlock) {
                    ...
                    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    URL = this.networks[erc20Wallet.network.name].getErc20TranApi + erc20Wallet.contract + "&address=" + erc20Wallet.address + "&startblock=" + startBlock + "&sort=desc&apikey=" + this.networks.ethToken;
                ...
                ERC20SDK.prototype.createTx = function (erc20Wallet, keypair, method, gasPrice, to, amount) {
                    ...
                    var web3 = new this.Web3(erc20Wallet.network.provider);
                    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var nonce, gas, gasLimit, estimatedGas, e_1, tx, removePrefix, privateKey, raw, fee, msToS, transaction;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (!(to && amount)) return [3 /*break*/, 5];
                                    _a.label = 2;
                                case 2:
                                    _a.trys.push([2, 4, , 5]);
                                    return [4 /*yield*/, this.estimateGas(erc20Wallet, to, amount, keypair.network.name)];
                                case 3:
                                ...
                                case 5:
                                    ...
                                    fee = (gasPrice * estimatedGas).toString();
                                    msToS = 1000;
                                    transaction = {
                                        fee: fee,
