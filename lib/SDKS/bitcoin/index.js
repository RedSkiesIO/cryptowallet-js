...
=======
            var BitcoinSDK = /** @class */ (function (_super) {
                ...
                function BitcoinSDK(net) {
                    return _super.call(this, net) || this;
>>>>>>> develop
                }
                /**
                 ...
                 */
<<<<<<< HEAD
                generateSegWit3of4MultiSigAddress(key1, key2, key3, key4, net) {
                    const network = this.networkInfo ? this.networkInfo : this.networks[net];
=======
                BitcoinSDK.prototype.generateSegWit3of4MultiSigAddress = function (key1, key2, key3, key4, net) {
...
>>>>>>> develop
                 ...
                 */
<<<<<<< HEAD
                generateP2SHMultiSig(keys, net) {
                    const network = this.networkInfo ? this.networkInfo : this.networks[net];
=======
                BitcoinSDK.prototype.generateP2SHMultiSig = function (keys, net) {
                    var network = this.networkInfo ? this.networkInfo : this.networks[net];
>>>>>>> develop
                    if (!network || !network.connect) {
                        throw new Error('Invalid network');
...
<<<<<<< HEAD
                getUTXOs(addresses, net) {
                    ...
                    return new Promise((resolve, reject) => {
                        ...
                        this.axios.post(URL, {
=======
                BitcoinSDK.prototype.getUTXOs = function (addresses, net) {
                    var _this = this;
                    var network = this.networkInfo ? this.networkInfo : this.networks[net];
                    if (!network || !network.connect) {
                        throw new Error('Invalid network');
