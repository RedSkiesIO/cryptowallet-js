...
(function (CryptoWallet) {
    ...
    (function (SDKS) {
        var GenericSDK = /** @class */ (function () {
             ...
             * @param network
             */
            GenericSDK.prototype.generateHDWallet = function (entropy, network) {
                ...
                var cointype = this.networks[network].bip;
                // root of node tree
            ...
            */
             ...
             * @param network
             */
            GenericSDK.prototype.importWIF = function (wif, network) {
                if (!this.networks[network].connect) {
                    throw new Error('Invalid network type');
                }
                var keyPair = this.bitcoinlib.ECPair.fromWIF(wif, this.networks[network].connect);
                var result = this.bitcoinlib.payments.p2sh({
                    redeem: this.bitcoinlib.payments.p2wpkh({
             ...
             * @param network
             */
            GenericSDK.prototype.broadcastTx = function (tx, network) {
                var _this = this;
                if (!this.networks[network] || !this.networks[network].connect) {
                    throw new Error('Invalid network type');
                }
                return new Promise(function (resolve, reject) {
                    if (_this.networks[network].segwit) {
                        _this.axios.post(_this.networks[network].broadcastUrl, { tx_hex: tx })
                            .then(function (r) {
                        ...
                        _this.axios.post(_this.networks[network].discovery + "/tx/send", { rawtx: tx })
                            .then(function (r) {
             ...
             * @param network
             */
            GenericSDK.prototype.validateAddress = function (address, network) {
                try {
             ...
             * @param network
             */
            GenericSDK.prototype.getTransactionFee = function (network) {
                var _this = this;
                if (!this.networks[network]) {
            ...
            */
            GenericSDK.prototype.createRawTx = function (accounts, change, utxos, wallet, toAddress, amount, minerRate, max) {
                ...
                return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    var balance, i, targets_1, result, inputs_1, inputs_2, outputs, fee, accountsUsed_1, p2shUsed_1, changeInputUsed_1, txb_1, maxValue_1, i_1, senders_1, convertMstoS, transaction, spentInput;
                    var _this = this;
            ...
            * @param transaction
            */
            GenericSDK.prototype.verifyTxSignature = function (transaction, network) {
                var _this = this;
                if (!this.networks[network] || !this.networks[network].connect) {
                    throw new Error('Invalid network type');
                }
                var keyPairs = transaction.pubKeys.map(function (q) { return _this.bitcoinlib.ECPair.fromPublicKey(Buffer.from(q, 'hex'), _this.networks[network].connect); });
            ...
            GenericSDK.prototype.accountDiscovery = function (wallet, internal) {
                ...
                var apiUrl = this.networks[wallet.network.name].discovery;
                var usedAddresses = [];
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                discover = function () { return __awaiter(_this, void 0, void 0, function () {
                                    var promises, gapLimit, _loop_1, this_1, i, max;
                                    var _this = this;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                _loop_1 = function (i) {
                                                    var number = i;
                                                    var keypair = this_1.generateKeyPair(wallet, number, internal);
                                                    promises.push(new Promise(function (res, rej) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                                        return [2 /*return*/, res(checkAddress(keypair.address, number))];
                                                    }); }); }));
                                                };
                                                this_1 = this;
                                            ...
                                            case 1:
                                                ...
                                                if (!(emptyAddresses.length < gapLimit)) return [3 /*break*/, 3];
                                                emptyAddresses = [];
             ...
             * @param to
             */
            GenericSDK.prototype.getTransactionHistory = function (addresses, network, from, to) {
                var _this = this;
                if (!this.networks[network].connect) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    var URL = apiUrl + "/addrs/" + addresses.toString() + "/txs?from=" + from + "&to=" + to;
                    _this.axios.get(URL)
                        .then(function (r) {
             ...
             * @param network
             */
            GenericSDK.prototype.getBalance = function (addresses, network) {
                var _this = this;
                if (!this.networks[network] || !this.networks[network].connect) {
                    throw new Error(network + " is an invalid network");
                }
