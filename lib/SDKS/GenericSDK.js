        ...
        class GenericSDK {
            ...
            */
            generateKeyPair(wallet, index, internal) {
                ...
                if (internal) {
                    node = Bip44hdkey.fromJSON(wallet.internal);
                }
            ...
            */
            ...
            broadcastTx(tx, network) {
                return new Promise((resolve, reject) => {
                    ...
                    if (this.networks[network].segwit) {
                        Request.post(this.networks[network].broadcastUrl, { form: { tx_hex: tx } }, (error, body, result) => {
                            if (error) {
      ...
      &api_key=${this.networks.cryptocompare}`;
                return new Promise((resolve, reject) => {
                    this.axios.get(URL)
                        ...
                        .catch((error) => reject(new Error(`No price data for "${coins}"`)));
                });
            }
