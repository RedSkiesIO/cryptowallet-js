...
*/
export var ethToken = process.env.ETHERSCAN_API_KEY;
export var cryptocompare = process.env.CRYPTOCOMPARE_API_KEY;
export var BITCOIN = {
    name: 'BITCOIN',
    bip: 0,
    segwit: true,
