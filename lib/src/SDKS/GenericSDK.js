        ...
        class GenericSDK {
            ...
            */
            ...
            getHistoricalData(coin, currency, period) {
                ...
                if (period === 'week') {
                    URL = `https://min-api.cryptocompare.com/data/histohour?fsym=${coin}&tsym=${currency}&limit=168`;
                }
                if (period === 'month') {
                    URL = `https://min-api.cryptocompare.com/data/histohour?fsym=${coin}&tsym=${currency}&limit=31`;
                }
                return new Promise((resolve, reject) => {
                    this.axios.get(URL)
