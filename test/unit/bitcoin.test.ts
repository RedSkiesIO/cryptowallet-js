...
describe('bitcoinSDK (wallet)', () => {
  ...
  //   assert.strictEqual(
  // keypair.publicKey, '0338306f579ff3bbbabcd2183bdd325757eb8610399f5178e8609daec510d0117e')
  //   assert.strictEqual(
  // keypair.privateKey, 'L3HzwnRNYi193kEQRJpNprvEwFB5BE7LfRMPw9xNJ3sPXNhDUe73')
